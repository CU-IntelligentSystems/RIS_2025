...
class EncoderControlNode(DTROS):
    def __init__(self, node_name):
        super(EncoderControlNode, self).__init__(node_name=node_name, node_type=NodeType.GENERIC)
    ...
    def run(self):
        ...
        max_speed = 0.7
        min_speed = 0.2
        distance = 5 #m  #idk it is dviitng by 3
...
if __name__ == '__main__':
    node = EncoderControlNode(node_name='encoder_control_node')
    node.run()
